...
if(file_exists( "original_".$room.".jpg")){
   if(!file_exists( "plant_".$room.".jpg"))         copy("original_".$room.".jpg", "plant_".$room.".jpg");
...
while($row = mysqli_fetch_row($result)){
   ...
   $out = $out."<span class='cur' onmouseout='revert()' onmouseover='preview(".$x1.",".$y1.",".$x2.",".$y2.")' style='font-size:12px'>".$showx1." ".$showy1." | ".$showx2." ".$showy2.'</span>&nbsp;<a href="deletePoint.php?id='.$id.'">Delete</a>&nbsp;&nbsp;&nbsp;<br>';
}
...
<html>
	<head>
	   ...
	   <script>
           ...
           function ajaxSend(query){
               ...
               xhttp.onreadystatechange = function() {
                  if (this.readyState == 4 && this.status == 200) {
	                 document.getElementById('mapa').src = "plant_<?php echo $room;?>.jpg?" + Math.random();
                     cleandivs();
                     redrawValues();
                  }
               };
           ...
           function seeMap(){
	           if(document.getElementById('seemap').checked == true){
		           document.getElementById('mapa').src = "emptyPlant_<?php echo $room;?>.jpg?<?php echo rand();?>";
	           }else{
		           document.getElementById('mapa').src = "plant_<?php echo $room;?>.jpg?<?php echo rand();?>"; 
	           }
           }
	...
	<body style="background-color: #DDDDDD">
		...
		<img onmouseenter="show()" onmouseleave="hide()" class="imagem" id="mapa" src="plant_<?php echo $room;?>.jpg?<?php echo rand();?>">
		<div style="position:fixed;top:140px;right:0px;background-color:#DDDDDD;">
			<span  valign="top" class="prompt"><b>Geometry segments</b><br><br>
		       <div id="pontos" style="background-color:#DDDDDD;height:500px;overflow:auto"><?php echo $out;?></div>
		    </span>
		</div>
		<script>
	        var coordx = [];
               ...
               $('img').mousemove(function(e) {
                ...
                $('img').click(function(e) {
                  ...
                  if(contador == 0){
	                  ...
	                  var dst = "saveDot.php?x1=" + parseInt(x1) + "&y1=" + parseInt(y1) + "&x2=" + parseInt(x2) + "&y2=" + parseInt(y2) + "&room=<?php echo $room;?>";
	                  ajaxSend(dst);
	                  contador = 0;
                  }
